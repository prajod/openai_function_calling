...
(Tested with version 1.2.4 of the openai api. This version was released in Nov 2023. This code will not work with earlier versions of openai api)
...
## Note: This notebook uses the OpenAI API version 1.2.4, which was released in Nov 2023. 
...
- #### Files:
  ...
  5. A .env file is needed to store your OPENAI_API_KEY. The notebook assumes that this file is present. The .env file is not added in this repo. Please create the file and add it to your source folder. See this link for help with .env files: https://www.runthat.blog/how-to-create-and-use-env-files-in-python/
